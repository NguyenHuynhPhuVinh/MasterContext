...
export function ProjectTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t("settings.project.watching.title")}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t("settings.autoSync.title")}</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <GitBranch className="h-5 w-5" /> {t("settings.git.title")}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t("settings.project.ignore.title")}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
